...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::group(['middleware' => 'auth'], function(){
        ...
        Route::get('rank', ['as' => 'rank', function(){
            ...
            $last_month_groups = \DB::select("select *, sum(recharge) as total from records where date_format(created_at,'%Y-%m')=date_format(DATE_SUB(curdate(), INTERVAL 1 MONTH),'%Y-%m') group by group_id order by total");
